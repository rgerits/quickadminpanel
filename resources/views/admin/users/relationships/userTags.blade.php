...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-userTags">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.tag.fields.user') }}
                        </th>
                        <th>
                            {{ trans('cruds.tag.fields.uuid') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
...
@endcan
  ...
  let table = $('.datatable-userTags:not(.ajaxTable)').DataTable({ buttons: dtButtons })
